<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select * from usuarios u inner join subDirector sb on(u.id_Usuario=sb.id_Usuario) inner join zona z on(u.claveEscuela=z.clave) where a.id_Usuario=u.id_Usuario and u.id_Usuario=".$_SESSION['id']);
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade in active" id="info">
          ...
          <div class="col-md-8 col-md-offset-1 registro1 well">
            ...
            <div id="div_NomDirector">
              <label>Nombre:</label><input id="txt_NomDirector" onkeypress="return validarXD(alphaxd,this.value.length,20);" onkeyup="validacion4all(/[a-zA-Z]{3,}/,'NomDirector',this.value);NomValid(this);"  type="text" class="form-control" name="txt_NomDirector" value="<?php echo $val['Nom']; ?>"><span id="span_NomDirector" ></span>
            </div>
            <div id="div_ApDirector">
              <label>Apellido paterno:</label><input id="txt_ApDirector" onkeypress="return validarXD(alphaxd,this.value.length,11);" onkeyup="validacion4all(/^[a-zA-Z](\s?[a-zA-Z]){2,10}$/,'ApDirector',this.value);NomValid(this);" type="text" class="form-control"  name="txt_ApDirector" value="<?php echo $val['Ap']; ?>"><span id="span_ApDirector" ></span>
            </div>
            <div id="div_AmDirector">
              <label>Apellido materno:</label><input id="txt_AmDirector" onkeypress="return validarXD(alphaxd,this.value.length,11);" onkeyup="validacion4all(/^[a-zA-Z](\s?[a-zA-Z]){2,10}$/,'AmDirector',this.value);NomValid(this);" type="text" class="form-control" name="txt_AmDirector" value="<?php echo $val['Am']; ?>"><span id="span_AmDirector" ></span>
            </div>
            <div id="div_TelcasaDirector" >
              <label>Teléfono casa: </label><input id="txt_TelcasaDirector" onkeypress="return validarXD(numeric,this.value.length,10);" onkeyup="validacion4all(/^[0-9]{8,10}$/,'TelcasaDirector',this.value);" type="text" class="form-control" name="txt_TelcasaDirector" value="<?php echo $val['Casa']; ?>"><span id="span_TelcasaDirector" ></span>
            </div>
            <div id="div_TelcelularDirector">
              <label>Teléfono celular:</label><input id="txt_TelcelularDirector"  onkeypress="return validarXD(numeric,this.value.length,10);" onkeyup="validacion4all(/^\+?\d{1,3}?[- .]?\(?(?:\d{2,3})\)?[- .]?\d\d\d[- .]?\d\d\d\d$/,'TelcelularDirector',this.value);" type="text" class="form-control" name="txt_TelcelularDirector" value="<?php echo $val['Celular']; ?>"><span id="span_TelcelularDirector" ></span>
            </div>
            <div id="div_CorreoDirector">
              <label>Correo:</label><input id="txt_CorreoDirector" onkeypress="return validarXD(helo,this.value.length,30);" onkeyup="validacion4all(/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/,'CorreoAlumno',this.value);" type="email" class="form-control" name="txt_CorreoDirector" value="<?php echo $val['Correo']; ?>" required><span id="span_CorreoDirector" ></span>
            </div>
            <div id="div_Curp">
                <label>CURP del Alumno:</label><input id="txt_Curp" onkeyup="validacion4all(/[A-Za-z]{4}[0-9]{6}[Hh,Mm][A-Za-z]{5}[A-Z0-9]{2}/,'Curp',this.value); return validaCurpE(this.value,'Alumno','#div_CurpRepetida');" onkeypress="return validateCurp(this.value.length);" style="text-transform: uppercase" type="text" class="form-control" name="txt_Curp" value="<?php echo $val['curpDirector']; ?>"><span id="span_Curp" ></span>
            </div>
            <div id="div_CurpRepetida" class="row"></div> 
            <br>
            <p align="center"><input type="submit" onclick="return modifica('Alumno','info',<?php echo $val['id_Usuario'];?>,'#aqui');" class="btn btn-success" value="Actualizar" name="btn_DirectorInfo"></p>
            <div id="aqui"></div>
          </div>
          </form>
          <div class="col-md-2">
        ...
        <form action="../php/UpdateTotal.php" method="POST">
          <div class="col-md-8 col-md-offset-1 registro1 well">
            ...
            <div id="div_CPDirector">
              <label>Código Postal:</label><input id="txt_CPDirector" onkeypress="return validarXD(numeric,this.value.length,5);" onkeyup="validacion4all(/^\d{4,5}$/,'CPDirector',this.value); return codigoEmp('../php/PostalEmp.php','txt_CPDirector','#codigop');"  type="text" class="form-control" name="txt_CPDirector" value="<?php echo $val['Codigo_Postal']; ?>"><span id="span_CPDirector" ></span>
            </div>
            <div id="codigop">
                <label for="Sl_PaisDirector">País:</label>
                <select class="form-control" name="Sl_PaisDirector" >
                <option>México</option>  </select>
                <label for="Sl_EstadoDirector">Estado:</label>
                <select class="form-control" name="Sl_EstadoDirector" >
                <option> <?php echo utf8_encode($val['Estado']); ?></option>
                </select>
                <label for="Sl_CiudadDirector">Ciudad:</label>
                <select class="form-control" name="Sl_CiudadDirector" >
                <option><?php echo $val['Ciudad']; ?></option>
                </select>
                <label for="Sl_ColoniaDirector">Colonia/Fraccionamiento:</label>
                <select class="form-control" name="Sl_ColoniaDirector">
                <option><?php echo $val['Colonia']; ?></option>
                </select>
            </div>
              <div id="div_CalleDirector">
                <label>Calle:</label><input id="txt_CalleDirector" onkeyup="validacion4all(/[0-9a-zA-Z]{5,}/,'CalleCanDirector',this.value);NomValid(this);NomValid(this);" type="text" class="form-control" name="txt_CalleDirector" value="<?php echo $val['Calle']; ?>" required><span id="span_CalleDirector" ></span>
              </div>
            <br>
            <p align="center"><input type="submit" class="btn btn-success" value="Actualizar" name="btn_DirectorDireccion"></p>
          </div>
          </form>
        </div>
        <div class="tab-pane fade" id="password">
           <form action="../php/UpdateTotal.php" method="POST" role="form">
            <div class="col-md-8 col-md-offset-1 registro1 well">
              ...
              <div id="div_PswDirector">
                <label>Contraseña:</label><input id="txt_PswDirector" type="password" class="form-control" name="txt_PswDirector"><span id="span_Psw" ></span>
              </div>
              <div id="div_Psw2Director">
                <label>Repite Contraseña:</label><input id="txt_Psw2Director" onkeyup="checkPwCan(this.value);" onblur="checkPwCan(this.value);" type="password" class="form-control" name="txt_Psw2Director"><br><span id="span_Psw2Director" ></span>
              </div>
              <p align="center"><input type="submit" class="btn btn-success" value="Actualizar" name="btn_DirectorPw"></p>
            </div>
            </form>
        </div>
                  ...
                  <div style="display:block;margin:10px;">
                    <div id="div_CambioZona"style="display: inline-block;margin: 20px;">
                      <form action="../php/UpdateTotal.php" method="POST" role="form">
                        ...
                        <select class="form-control" onchange="return selecion('queso','Director','#escuelas');" name="cambioZona" id="cambioZona">
