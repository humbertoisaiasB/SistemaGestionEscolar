<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select u.id_Usuario, u.Nom, u.Ap, u.Am, sb.id_SubDirector, sb.curpSubDirector, u.Documento FROM usuarios AS u INNER JOIN subDirector AS sb ON (sb.id_Usuario=u.id_Usuario)WHERE u.id_Usuario=".$_SESSION['id']." && u.id_Usuario=sb.id_Usuario");
...
<?php
  ...
  $curp = "'".$val['curpSubDirector']."'";
  $nombre = $val['Nom'].' '.$val['Ap'].' '.$val['Am'] ;
  $DocumentosR = $val['Documento'];
  $DocumentosR = 4-$DocumentosR;
?>
<body class="site" onload="return BuscarDocumentos(<?php echo $variable;?>,<?php echo $curp ?>,'SubDirector');">
	<main class="content">
     <div class="container">
        <div class="row">
