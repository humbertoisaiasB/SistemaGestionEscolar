<?php
	...
	if (isset($_POST['btn_Empresa'])){
	    ...
	    //if($row['claveEsc']==$_POST[txt_ClaveEscolar]){
			...
			if(!mysqli_query($con,"insert into alumnos(id_Usuario, id_Escuela, id_Grupo, curpAlumno, nomPapa, apPapa, amPapa, curpPapa, telPapa, nomMama, apMama, amMama, curpMama, telMama,Grado,Grupo) VALUES ('$numeroU', '$escuelaid','$grupoid','$curpA','$_POST[txt_nomPapa]', '$_POST[txt_apPapa]', '$_POST[txt_amPapa]', '$_POST[txt_curpPapa]', '$_POST[txt_telPapa]', '$_POST[txt_nomMama]', '$_POST[txt_apMama]', '$_POST[txt_amMama]', '$_POST[txt_curpMama]', '$_POST[txt_telMama]','$_POST[S_Grado]','$_POST[S_Grupo]')")){
				printf("Error: %s\n", mysqli_error($con));
			}
