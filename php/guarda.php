	...
	//include("Conexion.php");
	  //         $host = "localhost";
        //         $dbname = "f2c";
          //        $dbuser = "root";
            //      $dbpass = " ";
              //    if (isset($_POST['botonArre'])) {
                //  	$backup_file = "uploads/copia/".$dbname. "-" .date("Y-m-d-H-i-s").".gz";
	              //  $commands = "mysqldump --opt -h ".$host." -u ".$dbuser." -p".$dbpass." ".$dbname." | gzip >".$backup_file."";
	                //    system($commands,$output);
	                  //  echo $output;
	                 // echo '<script type="text/javascript">
			    		 //    alert ("'.$output.'La base de datos, ah sido guardaba");
			    		//	window.location.assign("../admin/save.php");
			    		//	</script>';
	                  //header('Location: ../admin/restauarar.php');
...
echo '<script type="text/javascript">
			    		     alert ("La base de datos, ah sido guardaba");
			    			window.location.assign("../admin/save.php");
			    			</script>';
