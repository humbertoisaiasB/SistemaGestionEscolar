...
?>	
	...
	<select class="form-control" name="<?php echo $idLocalidad;?>" id="<?php echo $idLocalidad;?>" onchange="ShowSelected(<?php echo $idLocalidadA;?>,<?php echo $Clave;?>,<?php echo $Destino1A;?>,<?php echo $Destino2A;?>);">
