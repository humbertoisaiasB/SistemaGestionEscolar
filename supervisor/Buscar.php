<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select u.id_Usuario, u.Nom, u.Ap, u.Am, s.id_Supervisor, s.curpSupervisor, u.Documento FROM usuarios AS u INNER JOIN supervisor AS s ON (s.id_Usuario=u.id_Usuario)WHERE u.id_Usuario=".$_SESSION['id']." && u.id_Usuario=s.id_Usuario");
...
<?php
  ...
  $curp = "'".$val['curpSupervisor']."'";
  $nombre = $val['Nom'].' '.$val['Ap'].' '.$val['Am'] ;
  $DocumentosR = $val['Documento'];
  $DocumentosR = 4-$DocumentosR;
?>
<body class="site" onload="return BuscarDocumentos(<?php echo $variable;?>,<?php echo $curp ?>,'Supervisor');">
	<main class="content">
     <div class="container">
        <div class="row">
