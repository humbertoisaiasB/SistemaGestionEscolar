<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select * from usuarios u inner join supervisor s on(u.id_Usuario=s.id_Usuario) inner join zona z on(u.claveEscuela=z.clave) where s.id_Usuario=u.id_Usuario and u.id_Usuario=".$_SESSION['id']);
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <h6 style="color: white;" class="centered">
                    <?php
                       echo "Tipo de Usuario: Supervisor";
                    ?>
                  </h6>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade in active" id="info">
          ...
          <div class="col-md-8 col-md-offset-1 registro1 well">
            ...
            <div id="div_ApSupervisor">
              <label>Apellido paterno:</label><input id="txt_ApSupervisor" onkeypress="return validarXD(alphaxd,this.value.length,11);" onkeyup="validacion4all(/^[a-zA-Z](\s?[a-zA-Z]){2,10}$/,'ApSupervisor',this.value);NomValid(this);" type="text" class="form-control"  name="txt_ApSupervisor" value="<?php echo $val['Ap']; ?>"><span id="span_ApSupervisor" ></span>
            </div>
            <div id="div_AmSupervisor">
              <label>Apellido materno:</label><input id="txt_AmSupervisor" onkeypress="return validarXD(alphaxd,this.value.length,11);" onkeyup="validacion4all(/^[a-zA-Z](\s?[a-zA-Z]){2,10}$/,'AmSupervisor',this.value);NomValid(this);" type="text" class="form-control" name="txt_AmSupervisor" value="<?php echo $val['Am']; ?>"><span id="span_AmSupervisor" ></span>
            </div>
            <div id="div_TelcasaSupervisor" >
              <label>Teléfono casa: </label><input id="txt_TelcasaSupervisor" onkeypress="return validarXD(numeric,this.value.length,10);" onkeyup="validacion4all(/^[0-9]{8,10}$/,'TelcasaSupervisor',this.value);" type="text" class="form-control" name="txt_TelcasaSupervisor" value="<?php echo $val['Casa']; ?>"><span id="span_TelcasaSupervisor" ></span>
            </div>
            <div id="div_TelcelularSupervisor">
              <label>Teléfono celular:</label><input id="txt_TelcelularSupervisor"  onkeypress="return validarXD(numeric,this.value.length,10);" onkeyup="validacion4all(/^\+?\d{1,3}?[- .]?\(?(?:\d{2,3})\)?[- .]?\d\d\d[- .]?\d\d\d\d$/,'TelcelularSupervisor',this.value);" type="text" class="form-control" name="txt_TelcelularSupervisor" value="<?php echo $val['Celular']; ?>"><span id="span_TelcelularSupervisor" ></span>
            </div>
        ...
        <form action="../php/UpdateTotal.php" method="POST">
          <div class="col-md-8 col-md-offset-1 registro1 well">
            ...
            <div id="codigop">
                <label for="Sl_PaisSupervisor">País:</label>
                <select class="form-control" name="Sl_PaisSupervisor" >
                <option>México</option>  </select>
                <label for="Sl_EstadoSupervisor">Estado:</label>
                <select class="form-control" name="Sl_EstadoSupervisor" >
                <option> <?php echo utf8_encode($val['Estado']); ?></option>
                </select>
                <label for="Sl_CiudadSupervisor">Ciudad:</label>
                <select class="form-control" name="Sl_CiudadSupervisor" >
                <option><?php echo $val['Ciudad']; ?></option>
                </select>
                <label for="Sl_ColoniaSupervisor">Colonia/Fraccionamiento:</label>
                <select class="form-control" name="Sl_ColoniaSupervisor">
                <option><?php echo $val['Colonia']; ?></option>
                </select>
            </div>
              <div id="div_CalleSupervisor">
                <label>Calle:</label><input id="txt_CalleSupervisor" onkeyup="validacion4all(/[0-9a-zA-Z]{5,}/,'CalleSupervisor',this.value);NomValid(this);NomValid(this);" type="text" class="form-control" name="txt_CalleSupervisor" value="<?php echo $val['Calle']; ?>" required><span id="span_CalleSupervisor" ></span>
              </div>
            <br>
            <p align="center"><input type="submit" class="btn btn-success" value="Actualizar" name="btn_SupervisorDireccion"></p>
          </div>
          </form>
        </div>
           ...
           <form action="../php/UpdateTotal.php" method="POST" role="form">
            <div class="col-md-8 col-md-offset-1 registro1 well">
              ...
              <div id="div_Psw2Supervisor">
                <label>Repite Contraseña:</label><input id="txt_Psw2Supervisor" onkeyup="checkPwCan(this.value);" onblur="checkPwCan(this.value);" type="password" class="form-control" name="txt_Psw2Supervisor"><br><span id="span_Psw2Supervisor" ></span>
              </div>
              <p align="center"><input type="submit" class="btn btn-success" value="Actualizar" name="btn_SupervisorPw"></p>
            </div>
            </form>
        </div>
