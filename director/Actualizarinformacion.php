<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select * from usuarios u inner join director a on(u.id_Usuario=a.id_Usuario) inner join zona z on(u.claveEscuela=z.clave) where a.id_Usuario=u.id_Usuario and u.id_Usuario=".$_SESSION['id']);
