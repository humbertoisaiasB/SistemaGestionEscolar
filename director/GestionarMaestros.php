...
?>
<body class="site" onload="return alumnosV('','Maestro','Consulta','todos','todos',<?php echo $variable;?>,'#ConsA2');">
  <main class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <ul class="nav nav-tabs">
              <li role="presentation" class="active" onclick="return alumnosV('','Maestro','Consulta','todos','todos',<?php echo $variable;?>,'#ConsA');"> <a href="#Consultar" data-toggle="tab"><img src="../assets/images/Consultar.png"  height="30px" width="30px" >  Consultar</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
                      ...
                      <div class="col-sm-12 busca well">
                        <h1>Consultar Maestro</h1>
                          <div class="input-group">
                            <input type="text" id="myInputA2" onkeyup="return alumnosV(this.value,'Maestro','Consulta','todos','todos',<?php echo $variable;?>,'#ConsA2');" class="form-control"  placeholder="Buscar por el nombre">
                            <div class="input-group-btn">
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'todos',<?php echo $variable;?>,'#ConsA2');">Todos.</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'A',<?php echo $variable;?>,'#ConsA2');">A</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'B',<?php echo $variable;?>,'#ConsA2');">B</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'C',<?php echo $variable;?>,'#ConsA2');">C</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'D',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'E',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'F',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',1,'G',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                </ul>
                              </div>
                              <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'todos',<?php echo $variable;?>,'#ConsA2');">Todos</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'A',<?php echo $variable;?>,'#ConsA2');">A</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'B',<?php echo $variable;?>,'#ConsA2');">B</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'C',<?php echo $variable;?>,'#ConsA2');">C</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'D',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'E',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'F',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',2,'G',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                </ul>
                              </div>
                              <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'todos',<?php echo $variable;?>,'#ConsA2');">Todos.</a>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'A',<?php echo $variable;?>,'#ConsA2');">A</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'B',<?php echo $variable;?>,'#ConsA2');">B</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'C',<?php echo $variable;?>,'#ConsA2');">C</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'D',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'E',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'F',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                  <li><a href="#" onclick="return alumnosV('','Maestro','Consulta',3,'G',<?php echo $variable;?>,'#ConsA2');">D</a></li>
                                </ul>
                              </div>
                            </div>
                        </div><br><br>
