<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select u.id_Usuario, u.Nom, u.Ap, u.Am, d.id_Director, d.curpDirector, u.Documento FROM usuarios AS u INNER JOIN director AS d ON (d.id_Usuario=u.id_Usuario)WHERE u.id_Usuario=".$_SESSION['id']." && u.id_Usuario=d.id_Usuario");
...
<?php
  ...
  $curp = "'".$val['curpDirector']."'";
  $nombre = $val['Nom'].' '.$val['Ap'].' '.$val['Am'] ;
  $DocumentosR = $val['Documento'];
  $DocumentosR = 4-$DocumentosR;
?>
<body class="site" onload="return BuscarDocumentos(<?php echo $variable;?>,<?php echo $curp ?>,'Director');">
	<main class="content">
     <div class="container">
        <div class="row">
