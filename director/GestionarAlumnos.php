...
<body class="site" onload="return CEmpleosAdmin('','Consultar','Administrador','Alumno','#ConsA2'); return CEmpleosAdmin('','Eliminar','Administrador','Alumno','#ConsA');">
  <main class="content">
                      ...
                      <div class="col-sm-12 busca well">
                        <h1>Consultar Alumno</h1>
                          <div class="input-group">
                            <input type="text" id="myInputA2" class="form-control" onkeyup="return CEmpleosAdmin(this.value,'Consultar','Administrador','Alumno','#ConsA2');" placeholder="Buscar por el nombre">
                ...
                <div class="tab-pane fade" id="Eliminar">
                      <div class="col-sm-12 busca well">
                        <h1>Eliminar Alumno</h1>
                            <div class="input-group">
                              <input type="text" id="myInputA" class="form-control" onkeyup="return CEmpleosAdmin(this.value,'Eliminar','Administrador','Alumno','#ConsA');" placeholder="Buscar por el nombre">
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" ariahaspopup="true" ariaexpanded="false">Filtros<span class="caret"></span></button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                  <li>
