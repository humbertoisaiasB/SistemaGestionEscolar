<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select u.id_Usuario, u.Nom, u.Ap, u.Am, pe.id_Personal, pe.curpAdmi, u.Documento FROM usuarios AS u INNER JOIN personaladmi AS pe ON (pe.id_Usuario=u.id_Usuario)WHERE u.id_Usuario=".$_SESSION['id']." && u.id_Usuario=pe.id_Usuario");
...
?>
<body class="site" onload="return BuscarDocumentos(<?php echo $variable;?>,<?php echo $curp ?>,'PersonalA');">
	<main class="content">
     <div class="container">
        <div class="row">
