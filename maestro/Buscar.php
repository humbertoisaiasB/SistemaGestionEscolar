<?php include '../php/Conexion.php';
      ...
      $query1 = mysqli_query($con,"select u.id_Usuario, u.Nom, u.Ap, u.Am, m.id_Maestro, m.curpMaestro, u.Documento FROM usuarios AS u INNER JOIN maestros AS m ON (m.id_Usuario=u.id_Usuario)WHERE u.id_Usuario=".$_SESSION['id']." && u.id_Usuario=m.id_Usuario");
...
<?php
  ...
  $curp = "'".$val['curpMaestro']."'";
  $nombre = $val['Nom'].' '.$val['Ap'].' '.$val['Am'] ;
  $DocumentosR = $val['Documento'];
  $DocumentosR = 4-$DocumentosR;
?>
<body class="site" onload="return BuscarDocumentos(<?php echo $variable;?>,<?php echo $curp ?>,'Maestro');">
	<main class="content">
     <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 registro1">
