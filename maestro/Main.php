...
<body class="site">
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" style="color:white !important;"  href="Main.php">Escuela</a>
      </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3 col-sm-3">
          <div class="row">
            <div class="col-md-12">
              <a href="#alumnos" class="thumbnail" data-toggle="tab">
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="#materias" class="thumbnail" data-toggle="tab">
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="#grupos" class="thumbnail" data-toggle="tab">
                <img src="../assets/images/chat.png" alt="..." height="100px" width="100px">
                <h3 align="center">Gestionar grupos</h3>
              </a>
            </div>
          </div>
        </div>
